"""
Transformer From Scratch - Dataset
"""
import os
import torch
...
class TransformerFromScratchDataset(Dataset):
    """Dataset for transformer from scratch."""
...
def get_dataloader(root, split, config):
    ...
    dataset = TransformerFromScratchDataset(root, split, transform)
    return DataLoader(
        dataset,
